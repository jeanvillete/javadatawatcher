...
public class XStreamFactory {
	...
	private void build() {
		...
		xStream.aliasField("transient-value", Column.class, "transientValue");
	...
	public DataWatcher fromXML(String xmlContent) {
		return (DataWatcher) xStream.fromXML(xmlContent);
	}
	...
	public DataWatcher fromXML(File file) {
		return (DataWatcher) xStream.fromXML(file);
	}
